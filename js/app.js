(() => {
    ...
    window.addEventListener("load", (function(e) {
        if (document.querySelector(".video__spider")) {
            const videoModule = document.querySelector(".video__spider");
            const video = videoModule.querySelector(".video__video");
            console.log(videoModule);
            videoModule.addEventListener("click", (function(e) {
                videoModule.classList.toggle("_active");
                console.log("_active");
                if (videoModule.classList.contains("_active")) video.play(); else video.pause();
            }));
